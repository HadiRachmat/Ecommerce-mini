...
export const BASE_POSITION_SUPERADMIN = 1;
export const BASE_POSITION_CUSTOMER_SERVICE = 2;
export const BASE_POSITION_WAREHOUSE = 3;
export const BASE_POSITION_FINANCE = 4;